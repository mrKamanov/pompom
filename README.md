...
├── options.html       # Страница настроек (современный UI, вкладки, подсказки)
├── options.js         # Логика настроек, переключение вкладок, маскировка ключа
...
### v1.12 (текущая)
* ✅ Добавлена поддержка OpenRouter.ai (выбор провайдера, отдельные ключ и модель)
* ✅ Кнопка-глазик для ключа OpenRouter
* ✅ Модель по умолчанию для OpenRouter: `google/gemma-3-27b-it:free`

### v1.11
* ✅ Современный UI настроек: вкладки, фирменные цвета, подсказки, описание для новых пользователей
* ✅ Исправления CSP (без inline-скриптов)
* ✅ Восстановлена маскировка API ключа и кнопка-глазик
* ✅ Восстановлены и улучшены горячие клавиши для промптов и автопечати
* ✅ Подготовка к поддержке нескольких AI API (папка API, масштабируемая архитектура)
* ✅ Обновлён README, добавлен TODO
